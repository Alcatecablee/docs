  ...
  const stages = [
    {
      ...
      name: 'Site Discovery',
      description:
        'Comprehensive site discovery — multi-domain crawling, sitemap parsing, subdomain enumeration, robots.txt-aware crawling, and link-graph analysis to prioritize high-value pages.',
    },
    {
      id: 2,
      name: 'Research & Analysis',
      description:
        'Aggregate community knowledge across Stack Overflow, GitHub, YouTube, Reddit, and official docs. Extract authoritative answers, issue threads, and transcripts, then quality-score and prioritize insights for documentation.',
    },
    {
      id: 3,
      name: 'Documentation Generation',
      description:
        'Synthesize research into structured documentation��getting started guides, tutorials, troubleshooting, FAQs, and API references—with embedded code samples and inline source attributions.',
    },
    {
      id: 4,
      name: 'Export & Optimization',
      description:
        'Apply brand styling, run accessibility and SEO checks, and export to PDF, DOCX, HTML, Markdown, or JSON. Optionally publish to a hosted subdomain with search and indexing enabled.',
    },
  ];
    ...
    try {
      ...
      try {
        ...
        if (!token) {
          ...
          toast({
            title: 'Sign in required',
            description: 'Please sign in to download generated files',
          });
          return;
        }
      } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-[rgb(14,19,23)]">
      ...
      <main id="main-content">
        <section
          id="hero"
          className="relative overflow-hidden bg-gradient-to-b from-[rgb(14,19,23)] via-[rgb(24,29,37)] to-[rgb(34,38,46)]"
        >
          {/* Background Elements */}
            ...
            <div className="container mx-auto px-6 max-w-5xl text-center">
              <div className="space-y-10">
                ...
                <h1 className="text-6xl md:text-7xl lg:text-8xl font-black leading-tight text-white tracking-tight space-y-3">
                  <span className="text-[rgb(102,255,228)] block">
                ...
                <p className="text-lg lg:text-xl text-white/80 leading-relaxed max-w-3xl mx-auto font-light text-center">
                  We aggregate knowledge across <strong>Stack Overflow</strong>,{' '}
                  <strong>GitHub</strong>, <strong>YouTube</strong>, <strong>Reddit</strong>, and
                  10+ sources then generate beautiful, <strong>Apple-quality docs</strong> that
                  match your brand.
                </p>
              ...
              <div className="relative aspect-[16/9] w-full rounded-3xl border-2 border-white/25 hover:border-[rgb(102,255,228)]/50 bg-gradient-to-br from-white/15 via-white/10 to-white/5 backdrop-blur-xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.3)] hover:shadow-[0_30px_80px_rgba(102,255,228,0.2)] transition-all duration-500 group">
                ...
                <div className="relative flex items-center justify-center h-full p-8">
                  <div className="text-center">
                    <div
                      id="demo"
                      className="w-28 md:w-36 h-28 md:h-36 mx-auto mb-8 rounded-3xl bg-gradient-to-br from-[rgb(102,255,228)]/20 to-[rgb(102,255,228)]/10 backdrop-blur-sm flex items-center justify-center border-2 border-[rgb(102,255,228)]/40 shadow-2xl hover:scale-110 hover:shadow-[0_20px_50px_rgba(102,255,228,0.3)] transition-all duration-300 cursor-pointer group/play focus:outline-none focus:ring-4 focus:ring-[rgb(102,255,228)]/50"
                      role="button"
                      tabIndex={0}
                      onKeyDown={(e) => {
                    ...
                    >
                      <PlayCircleIcon
                        className="h-16 md:h-20 w-16 md:w-20 text-[rgb(102,255,228)] group-hover/play:scale-110 transition-transform"
                        aria-hidden="true"
                      />
                    </div>
                    ...
                    <div className="relative bg-gradient-to-br from-white/15 to-white/5 border border-white/25 hover:border-[rgb(102,255,228)]/50 rounded-2xl p-6 md:p-8 transition-all duration-500 backdrop-blur-sm hover:shadow-[0_15px_40px_rgba(102,255,228,0.15)] hover:scale-105">
                      <div className="flex flex-col items-center text-center gap-3">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[rgb(102,255,228)]/20 to-[rgb(102,255,228)]/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                          <stat.icon
                            className="h-6 w-6 text-[rgb(102,255,228)]"
                            strokeWidth={1.5}
                          />
                        </div>
                        <div className="text-3xl md:text-4xl font-bold text-white group-hover:text-[rgb(102,255,228)] transition-colors">
                          {stat.num}
                        </div>
        ...
        <section
          id="how-it-works"
          className="relative overflow-hidden bg-gradient-to-br from-[rgb(14,19,23)] via-[rgb(24,29,37)] to-[rgb(34,38,46)] py-32 lg:py-40"
        >
          {/* Background Elements */}
          <div className="absolute inset-0 bg-grid-white/[0.02] opacity-30" />
          ...
          <div className="relative container mx-auto px-6 max-w-7xl">
            ...
            <div className="text-center mb-24">
              ...
              <p className="text-lg md:text-xl text-white/70 max-w-3xl mx-auto font-light">
                From URL to professional documentation in minutes. A fully automated pipeline that
                researches, synthesizes, and exports beautiful docs.
              </p>
            </div>
                  ...
                  <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                    <div className="flex-shrink-0">
                      <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[rgb(102,255,228)]/20 to-[rgb(102,255,228)]/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <GlobeAltIcon
                          className="h-8 w-8 text-[rgb(102,255,228)]"
                          strokeWidth={1.5}
                        />
                      </div>
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <span className="text-sm font-bold text-[rgb(102,255,228)] uppercase tracking-wider">
                          Step 1
                        </span>
                      ...
                      <p className="text-white/70 text-base leading-relaxed">
                        Simply paste your website URL and we'll handle the rest. Our system
                        automatically discovers your entire product ecosystem.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative bg-gradient-to-br from-white/10 to-white/5 border border-white/20 hover:border-[rgb(102,255,228)]/50 rounded-3xl p-8 md:p-10 transition-all duration-500 backdrop-blur-sm hover:shadow-[0_20px_50px_rgba(102,255,228,0.1)]">
                  <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-white/70 text-base leading-relaxed">
                        Multi-domain crawling, sitemap parsing, subdomain enumeration, and
                        intelligent link-graph analysis to prioritize high-value pages and extract
                  ...
                  <div className="flex flex-col md:flex-row items-start gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-white/70 text-base leading-relaxed mb-6">
                        We aggregate community knowledge across 10+ authoritative sources to capture
                        how developers actually use your product.
                      </p>
                      ...
                      <div className="grid grid-cols-3 md:grid-cols-5 gap-3">
                        {[
                          {
                            image:
                              '/attached_assets/images/Stack-Overflow-Logo-emblem-of-the-programming-community-transparent-png-image.png',
                          ...
                          {
                            image:
                              '/attached_assets/images/toppng.com-reddit-logo-reddit-icon-698x698.png',
                            label: 'Reddit',
                          },
                          { image: '/attached_assets/images/dev-rainbow.png', label: 'DEV.to' },
                          {
                            image:
                              '/attached_assets/images/toppng.com-custom-software-development-web-application-development-451x333.png',
                            label: 'CodeProject',
                          },
                          {
                            image:
                              'https://cdn.builder.io/api/v1/image/assets%2Fc524d11d3a984ad6ba413cc77a150641%2Faac4e760a8544892bd6e5f6a40054f2c?format=webp&width=800',
                            label: 'Stack Exchange',
                          },
                          {
                            image:
                              'https://cdn.builder.io/api/v1/image/assets%2Fc524d11d3a984ad6ba413cc77a150641%2F3e4b910659394a4ba3676e420f451025?format=webp&width=800',
                            label: 'Quora',
                          },
                          ...
                          <div
                            key={source.label}
                            className="flex flex-col items-center gap-2 p-3 rounded-xl bg-white/5 border border-white/10 hover:border-[rgb(102,255,228)]/30 transition-all"
                          >
                            {source.image ? (
                              <img
                                src={source.image}
                ...
                <div className="relative bg-gradient-to-br from-white/10 to-white/5 border border-white/20 hover:border-[rgb(102,255,228)]/50 rounded-3xl p-8 md:p-10 transition-all duration-500 backdrop-blur-sm hover:shadow-[0_20px_50px_rgba(102,255,228,0.1)]">
                  <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-white/70 text-base leading-relaxed">
                        Advanced AI transforms scattered research into coherent, comprehensive
                        documentation with proper structure, code examples, and source citations.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col md:flex-row items-start gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-white/70 text-base leading-relaxed mb-4">
                        Pro and Enterprise plans include comprehensive SEO optimization to ensure
                        your documentation ranks well and drives organic traffic.
                      </p>
                ...
                <div className="relative bg-gradient-to-br from-[rgb(102,255,228)]/15 to-[rgb(102,255,228)]/5 border-2 border-[rgb(102,255,228)]/40 rounded-3xl p-8 md:p-10 transition-all duration-500 backdrop-blur-sm shadow-[0_20px_50px_rgba(102,255,228,0.15)]">
                  <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-white/70 text-base leading-relaxed mb-4">
                        Export your documentation in multiple formats, all matching your brand
                        identity and ready for immediate deployment.
                      </p>
                      <div className="flex flex-wrap gap-2">
                        {['PDF', 'DOCX', 'HTML', 'Markdown', 'JSON'].map((format) => (
                          <div
                            key={format}
                            className="px-4 py-2 rounded-lg bg-white/10 border border-[rgb(102,255,228)]/30 text-white/80 text-sm font-semibold hover:bg-white/15 transition-all"
                          >
                            {format}
                          </div>
                        ))}
            ...
            <div className="text-center mt-20">
              <div className="inline-flex flex-col items-center gap-4 px-8 py-6 rounded-3xl bg-gradient-to-br from-white/10 to-white/5 border border-white/20 backdrop-blur-sm">
                <p className="text-white/80 text-lg font-light">
                  <span className="font-bold text-[rgb(102,255,228)]">Average build time:</span> 5
                  minutes
                </p>
                <Button
                  size="lg"
            ...
            <div className="mb-8 glass-effect rounded-2xl p-6">
              <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
                ...
                <div className="flex gap-2 flex-wrap">
                  ...
                  />
                  <ThemeSwitcher currentTheme={selectedTheme} onThemeChange={setSelectedTheme} />
                </div>
              </div>
        ...
        {!generatedDoc && (
          <section
            id="why"
            className="relative overflow-hidden bg-gradient-to-br from-[rgb(142,209,198)] via-[rgb(152,219,208)] to-[rgb(142,209,198)] py-32 lg:py-40"
          >
            {/* Background Elements */}
            ...
            <div className="relative container mx-auto px-6 max-w-7xl">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-xl md:text-2xl text-gray-800 max-w-3xl mx-auto leading-relaxed">
                  <strong>DevRel teams</strong> at established companies spend 20-40 hours per month
                  manually researching Stack Overflow, GitHub, and community discussions.{' '}
                  <strong>We automate it.</strong>
                </p>
              </div>
              ...
              <div className="mt-16 text-center">
                <div className="inline-flex flex-col items-center gap-4 px-10 py-8 rounded-3xl bg-white/70 backdrop-blur-sm border-2 border-gray-900/20 shadow-2xl">
                  ...
                  <h4 className="text-2xl md:text-3xl font-bold text-gray-900">
                    We Solve All of This for DevRel Teams
                  </h4>
                  <p className="text-lg text-gray-800 max-w-xl">
                    Automated community intelligence, continuous documentation refresh, and
                    enterprise-grade reliability—all for less than one technical writer's hourly
                    rate.
                  </p>
                  <Button
                    size="lg"
            ...
            <div className="relative container mx-auto px-6 max-w-7xl">
              ...
              <div className="text-center mb-24">
                ...
                <p className="text-lg md:text-xl text-white/70 max-w-3xl mx-auto mb-12 font-light">
                  No guessing. We research how developers actually use your product across 10+
                  authoritative sources and synthesize comprehensive documentation.
                </p>
                    ...
                    <div key={idx} className="group relative">
                      <div className="relative bg-gradient-to-br from-white/10 to-white/5 border border-white/20 hover:border-[rgb(102,255,228)]/50 rounded-2xl p-6 transition-all duration-500 backdrop-blur-sm hover:shadow-[0_10px_30px_rgba(102,255,228,0.15)]">
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="text-center">
                            <div className="text-3xl font-bold text-white mb-1 group-hover:text-[rgb(102,255,228)] transition-colors">
                              {stat.metric}
                            </div>
                            <p className="text-sm text-white/70 leading-tight">{stat.label}</p>
                          </div>
                ...
                <div className="relative bg-gradient-to-br from-[rgb(102,255,228)]/15 to-[rgb(102,255,228)]/5 border-2 border-[rgb(102,255,228)]/40 rounded-3xl p-10 md:p-12 max-w-4xl mx-auto backdrop-blur-sm shadow-[0_20px_50px_rgba(102,255,228,0.2)] hover:shadow-[0_30px_70px_rgba(102,255,228,0.25)] transition-all duration-500">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-white/90 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
                      We analyze your website, then research across{' '}
                      <strong className="text-white">Stack Overflow</strong>,{' '}
                      <strong className="text-white">GitHub</strong>,{' '}
                      <strong className="text-white">YouTube</strong>,{' '}
                      <strong className="text-white">Reddit</strong>,{' '}
                      <strong className="text-white">DEV.to</strong>,{' '}
                      <strong className="text-white">CodeProject</strong>,{' '}
                      <strong className="text-white">Stack Exchange</strong>,{' '}
                      <strong className="text-white">Quora</strong>, and official forums. Every
                      insight is quality-scored and source-attributed for maximum reliability.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-center gap-4 mb-6">
                      <div className="p-3 bg-[rgb(102,255,228)]/25 rounded-full">
                        <CheckBadgeIcon
                          className="h-10 w-10 text-[rgb(102,255,228)]"
                          aria-hidden="true"
                        />
                      </div>
                    ...
                    <p className="text-white/90 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
                      Every insight is traced to its source. Quality scored, validated for
                      reliability, and fully transparent so you can verify any claim.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-24">
                  ...
                  <div className="w-full overflow-hidden relative">
                    ...
                    <div className="flex gap-8 animate-scroll-sources">
                      ...
                      {[
                        ...
                        {
                          image:
                            'https://cdn.builder.io/api/v1/image/assets%2Fc524d11d3a984ad6ba413cc77a150641%2Fdbf37a3ec2b54b77b7a7c9fb35f3bd73?format=webp&width=800',
                          name: 'Web Search',
                        },
                        ...
                        <div className="relative bg-gradient-to-br from-white/10 to-white/5 hover:from-white/15 hover:to-white/10 border border-white/20 hover:border-[rgb(102,255,228)]/50 rounded-2xl p-6 md:p-7 transition-all duration-400 h-full backdrop-blur-sm hover:shadow-[0_15px_40px_rgba(102,255,228,0.15)] hover:scale-105">
                          ...
                          <div className="flex flex-col items-center text-center gap-3 h-full relative z-10">
                            <div className="w-14 h-14 rounded-xl bg-white/15 group-hover:bg-[rgb(102,255,228)]/25 flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 shadow-lg">
                              <item.icon
                                className="h-6 w-6 text-white/80 group-hover:text-[rgb(102,255,228)] transition-colors"
                                strokeWidth={1.5}
                              />
                            </div>
                            <div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-5">
                    {[
                      {
                        image: '/attached_assets/images/toppng.com-exporter-pdf-en-450x423.png',
                        name: 'PDF',
                        desc: 'Print-Ready',
                      },
                      {
                        image:
                          '/attached_assets/images/toppng.com-shadow-microsoft-icons-by-blackvariant-microsoft-office-2013-899x899.png',
                        name: 'DOCX',
                        desc: 'Editable Docs',
                      },
                      {
                      ...
                      {
                        image: '/attached_assets/images/toppng.com-markdown-logo-830x512.png',
                        name: 'Markdown',
                        desc: 'Developer Format',
                      },
                      {
                        image:
                          '/attached_assets/images/json-file-document-icon-png-image_927931.jpg',
                        name: 'JSON',
            ...
            <div className="relative container mx-auto px-6 max-w-5xl text-center">
              <div className="space-y-8 md:space-y-12">
                ...
                <h2 className="text-4xl md:text-6xl lg:text-7xl font-black leading-tight text-white tracking-tight">
                  Try it for{' '}
                  <span className="text-[rgb(102,255,228)] font-semibold">
                    free<span className="text-[rgb(102,255,228)] font-black">.</span>
                  </span>
                </h2>

                {/* Description */}
                <p className="text-lg md:text-2xl lg:text-3xl text-[rgb(228,232,236)] leading-relaxed max-w-3xl mx-auto font-light">
                  Join&nbsp;<strong className="font-semibold">DevRel teams</strong>&nbsp;at
                  established companies who've automated their community research. Save 20-40 hours
                  per month and keep docs aligned with reality&nbsp;
                  <strong className="font-semibold">automatically</strong>
                </p>
